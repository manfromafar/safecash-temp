...
By default, safecashd will dump mempool on shutdown and
...
class MempoolPersistTest(SafeCashTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give safecashd a second to reload the mempool
        ...
        self.log.debug("Prevent safecashd from writing mempool.dat to disk. Verify that `savemempool` fails")
