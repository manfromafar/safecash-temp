...
class WalletTest(SafeCashTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SCASH from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SCASH with subtract fee from amount
        ...
        # Sendmany 10 SCASH with subtract fee from amount
