...
#ifndef SAFECASH_QT_SAFECASHUNITS_H
#define SAFECASH_QT_SAFECASHUNITS_H
...
/** SafeCash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SafeCashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SafeCashUnits(QObject *parent);
    ...
    //! Number of Scashis (1e-8) per unit
    ...
    //! Return maximum number of base units (Scashis)
    static CAmount maxMoney();

private:
    QList<SafeCashUnits::Unit> unitlist;
};
typedef SafeCashUnits::Unit SafeCashUnit;

#endif // SAFECASH_QT_SAFECASHUNITS_H
