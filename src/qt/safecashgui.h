...
#ifndef SAFECASH_QT_SAFECASHGUI_H
#define SAFECASH_QT_SAFECASHGUI_H
...
*/
class SafeCashGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SafeCashGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~SafeCashGUI();
...
#endif // SAFECASH_QT_SAFECASHGUI_H
